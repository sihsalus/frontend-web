export default function PaperIlustration() {
  return (
    <svg width="64" height="64" viewBox="0 0 64 64">
      <g fill="none" fill-rule="evenodd">
        ...
        <path
          ...
          fill="#C6C6C6"
        ></path>
        <circle fill="#C6C6C6" cx="17.636" cy="2.314" r="1.855"></circle>
        <circle fill="#FFF" fill-rule="nonzero" cx="17.636" cy="2.314" r="1.175"></circle>
        <path
        ...
        <path
          ...
          fill="#C6C6C6"
        ></path>
        <circle fill="#C6C6C6" cx="40.218" cy="9.755" r="1.855"></circle>
        <circle fill="#FFF" fill-rule="nonzero" cx="40.218" cy="9.755" r="1.13"></circle>
      </g>
    </svg>
  );
}
