...
const SpaceBetweenFinding1 = ({
  ...
  const intermediateSpaceOnTheCanvasOfFinding1 = useSpaceBetweenLegendsDataStore((state: any) => state.intermediateSpaceOnTheCanvasOfFinding1);
  const toggleColorSpaceBetweenFinding1 = useSpaceBetweenLegendsDataStore((state: any) => state.toggleColorSpaceBetweenFinding1);

  // Obtener el color guardado para este espacio
  const legend = intermediateSpaceOnTheCanvasOfFinding1.find((item: any) => item.id === id);
